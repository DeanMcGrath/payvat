            ...
            <div className="max-w-4xl mx-auto animate-fade-in">
              <div className="mb-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-2">
                  <span className="text-gradient-primary">Accountant Fees vs</span>
                  <br />
                  <span className="text-foreground">PayVat Savings</span>
                </h1>
                
                <div className="w-32 h-1 gradient-primary mx-auto mb-4 rounded-full"></div>
                
                <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Real cost comparison between traditional accountants and PayVat. See exactly how much you'll save while gaining speed, control, and transparency.
                </p>
              </div>
              ...
              <div className="flex items-center justify-center gap-8 text-muted-foreground text-sm mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>€2.3M saved by customers</span>
                </div>
              </div>
            </div>
          </div>
          
          <div className="absolute top-20 left-10 w-16 h-16 bg-green-200 rounded-full blur-xl opacity-20 animate-float"></div>
          <div className="absolute top-32 right-20 w-12 h-12 bg-green-300 rounded-full blur-lg opacity-30 animate-float" style={{animationDelay: '-2s'}}></div>
          <div className="absolute bottom-20 left-20 w-20 h-20 bg-green-100 rounded-full blur-2xl opacity-25 animate-float" style={{animationDelay: '-4s'}}></div>
        </div>
      </section>
