  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">E-commerce Store</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Digital Services</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Marketplace Seller</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 1: Legal Foundation (Weeks 1-2)</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Data Protection Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">VAT Registration Strategy</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 2: Digital Infrastructure (Weeks 2-4)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-gray-600 rounded-full"></div>
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Website & E-commerce Platform</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Payment Processing</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">EU VAT Compliance System</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 3: Operational Setup (Weeks 3-6)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Business Bank Account & Finance</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Insurance & Legal Protection</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Fulfillment & Customer Service</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 4: Marketing & Launch (Weeks 4-8)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">SEO & Content Strategy</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Digital Marketing Setup</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Analytics & Optimization</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">B2C Sales (to Consumers)</h3>
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-normal text-gray-900 mb-2">Goods (E-commerce)</h4>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-normal text-green-900 mb-2">Digital Services</h4>
              ...
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">B2B Sales (to Businesses)</h3>
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-normal text-blue-900 mb-2">Goods & Services</h4>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-normal text-orange-900 mb-2">Validation Required</h4>
            ...
            <div className="card-premium p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a 
                  href="/pricing" 
                  className="px-8 py-4 text-lg font-normal text-petrol-base border-2 border-petrol-200 rounded-xl hover:bg-gray-50 transition-all duration-300"
                >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="card-modern p-6">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Basic Online Store</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    ...
                    <span className="font-normal text-sm">€300</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                  ...
                  <div className="flex justify-between items-center font-normal pt-2">
                    ...
                    <span className="text-petrol-base">€5,300</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-6 border-2 border-petrol-200">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Professional Store</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Company Registration</span>
                    <span className="font-normal text-sm">€200</span>
                  ...
                  <div className="flex justify-between items-center font-normal pt-2">
                    <span className="text-gray-900">Total</span>
                    <span className="text-petrol-base">€16,400</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-6">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Enterprise Store</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Company Registration</span>
                    <span className="font-normal text-sm">€200</span>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    ...
                    <span className="font-normal text-sm">€15,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Legal & Compliance</span>
                    <span className="font-normal text-sm">€5,000</span>
                  ...
                  <div className="flex justify-between items-center font-normal pt-2">
                    <span className="text-gray-900">Total</span>
                    <span className="text-petrol-base">€50,200</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-premium p-8 text-center">
              ...
              <div className="grid md:grid-cols-5 gap-4 mb-6">
                <div>
                  ...
                  <div className="text-lg font-normal text-gray-900">€50-500</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Marketing</div>
                  <div className="text-lg font-normal text-gray-900">€500-5,000</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Payment Fees</div>
                  <div className="text-lg font-normal text-gray-900">1.4-2.9%</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-lg font-normal text-gray-900">€49-199</div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-modern p-8 border-l-4 border-red-500">
                <h3 className="text-xl font-normal text-red-600 mb-3">Mistake: Ignoring EU VAT Rules</h3>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <p className="text-red-800 font-normal">Penalty: Up to 100% of VAT due + €4,000 per missed return</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-orange-500">
                <h3 className="text-xl font-normal text-orange-600 mb-3">Mistake: Poor Data Protection Compliance</h3>
                <p className="text-gray-700 mb-4">
                  Not registering with DPC, inadequate privacy policies, no cookie consent, failing to secure customer data properly.
                </p>
                <div className="bg-orange-50 p-4 rounded-lg">
                  <p className="text-orange-800 font-normal">Risk: GDPR fines up to €20M or 4% of global turnover</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-yellow-500">
                <h3 className="text-xl font-normal text-yellow-600 mb-3">Mistake: Inadequate Payment Security</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="text-yellow-800 font-normal">Cost: Chargebacks (€15-25 each) + potential €10,000+ fraud losses</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-petrol-500">
                <h3 className="text-xl font-normal text-gray-600 mb-3">Mistake: Manual Financial Management</h3>
                <p className="text-gray-700 mb-4">
                  Trying to track multi-currency sales, varying VAT rates, and platform fees manually without integrated accounting.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-800 font-normal">Impact: Significant time on admin + accuracy errors costing money</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Call to Action */}
        <section className="scroll-section py-20 px-4 bg-petrol-base text-white">
