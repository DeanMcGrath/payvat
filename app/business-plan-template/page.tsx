          ...
          <Card className="shadow-xl border-2 border-blue-100 mb-8">
            <CardHeader>
              <CardTitle className="text-xl flex items-center gap-2">
                <Target className="h-6 w-6 text-[#73C2FB]" />
                Your Progress
              </CardTitle>
              <CardDescription>
          ...
          <div className="space-y-8">
            {templateSections.map((section, index) => (
              <Card 
                ...
                } ${completedSections.includes(section.id) ? 'border-blue-200' : ''}`}
              >
                <CardHeader 
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#8FD0FC] to-[#5BADEA] p-0.5">
                        <div className="w-full h-full rounded-xl bg-white flex items-center justify-center">
                          <section.icon className="h-8 w-8 text-[#73C2FB]" />
                        </div>
                      </div>
                      <div>
                  ...
                  <CardContent className="animate-slide-down">
                    <div className="grid gap-6 lg:grid-cols-2">
                      <div className="space-y-6">
                        <div>
                          <h4 className="font-semibold text-lg mb-3 text-gray-900">Overview</h4>
                          <p className="text-gray-600">{section.content.overview}</p>
                        </div>
                        
                        <div>
                          <h4 className="font-semibold text-lg mb-3 text-gray-900">Key Elements to Include</h4>
                          <ul className="space-y-2">
                            {section.content.keyPoints.map((point, idx) => (
                              <li key={idx} className="flex items-start gap-2">
                                <CheckCircle className="h-4 w-4 text-[#73C2FB] mt-0.5 flex-shrink-0" />
                      ...
                      <div className="bg-blue-50 p-6 rounded-lg">
                        <h4 className="font-semibold text-lg mb-3 text-blue-900 flex items-center gap-2">
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      ...
                      <Button variant="outline" className="text-[#73C2FB] border-[#73C2FB]">
            ...
            {downloadableResources.map((resource, index) => (
              <Card key={index} className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-[#8FD0FC] to-[#5BADEA] p-0.5 mb-4 mx-auto">
                    <div className="w-full h-full rounded-lg bg-white flex items-center justify-center">
                      <resource.icon className="h-8 w-8 text-[#73C2FB]" />
                    </div>
                  </div>
