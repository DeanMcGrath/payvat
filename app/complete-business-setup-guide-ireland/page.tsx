            ...
            <div className="max-w-4xl mx-auto animate-fade-in">
              <div className="mb-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-3 animate-bounce-gentle">
                  ...
                  Complete 2025 guide for Irish entrepreneurs
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-2">
                  <span className="text-gradient-primary">Complete Business Setup</span>
                  <br />
                  <span className="text-foreground">Guide for Ireland</span>
                </h1>
                
                <div className="w-32 h-1 gradient-primary mx-auto mb-4 rounded-full"></div>
                
                <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  The definitive step-by-step guide to starting your business in Ireland. From choosing your structure to VAT registration—everything you need in one place.
                </p>
              </div>
