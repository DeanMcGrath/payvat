      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="card-premium p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">{auditPhases[selectedPhase].name}</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {auditPhases[selectedPhase].items.map((item, index) => (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Comprehensive Audit</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-semibold mb-2">Scope:</p>
                  ...
                  <div className="bg-red-50 p-3 rounded">
                    <p className="text-red-800 text-xs font-medium">Most intensive audit type</p>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Aspect Audit</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-semibold mb-2">Scope:</p>
                    <ul className="space-y-1">
                  ...
                  <div className="bg-yellow-50 p-3 rounded">
                    <p className="text-yellow-800 text-xs font-medium">Focused examination</p>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Desktop Audit</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-semibold mb-2">Scope:</p>
                    <ul className="space-y-1">
                  ...
                  <div className="bg-green-50 p-3 rounded">
                    <p className="text-green-800 text-xs font-medium">Less intrusive process</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 px-4" id="documentation-checklist">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Core Financial Records</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Accounting Records</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Tax-Specific Records</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">VAT Documentation</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
                        <span className="text-amber-500">✓</span>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">PAYE/Payroll Records</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
                        <span className="text-amber-500">✓</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-premium p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-green-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-green-900 mb-2">Professional Representation</h4>
                      <p className="text-green-800 text-sm">Right to have qualified tax advisor represent you during audit proceedings</p>
                    </div>
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-900 mb-2">Reasonable Notice</h4>
                      <p className="text-blue-800 text-sm">Revenue must provide reasonable advance notice of audit commencement</p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-purple-900 mb-2">Appeal Process</h4>
                      <p className="text-purple-800 text-sm">Right to appeal Revenue findings through formal appeals process</p>
                    </div>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-indigo-900 mb-2">Confidentiality</h4>
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Your Obligations</h3>
                  <div className="space-y-4">
                    <div className="bg-red-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-red-900 mb-2">Cooperation Duty</h4>
                      <p className="text-red-800 text-sm">Must cooperate fully with Revenue audit and provide requested information</p>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-orange-900 mb-2">Document Production</h4>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-yellow-900 mb-2">Truthful Information</h4>
                      <p className="text-yellow-800 text-sm">All information provided must be accurate and complete</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Access Provision</h4>
        ...
        <section className="py-16 px-4" id="settlement-options">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Settlement Strategies</h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Voluntary Disclosure</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Agreed Settlement</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Payment Arrangements</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Penalty Mitigation</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Penalty Factors</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Aggravating Factors</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Mitigating Factors</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
