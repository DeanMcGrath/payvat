            ...
            <div className="max-w-4xl mx-auto animate-fade-in">
              <div className="mb-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-2">
                  <span className="text-gradient-primary">Avoid Revenue Penalties</span>
                  <br />
                ...
                <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Protect your business from costly Revenue penalties. Understand compliance deadlines, calculate potential costs, and implement systems to stay penalty-free.
                </p>
              </div>
              ...
              <div className="flex items-center justify-center gap-8 text-muted-foreground text-sm mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>2025 penalty rates</span>
                </div>
                <div className="flex items-center gap-2">
                  <Users className="h-4 w-4 text-success" />
                  <span>Zero penalties for PayVat users</span>
                </div>
              </div>
            </div>
          </div>
