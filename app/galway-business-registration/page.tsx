      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
              ...
              <div className="space-y-6">
                ...
                <div className="card-modern p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-normal text-gray-900 mb-3">Companies Registration Office</h3>
                      <ul className="space-y-2 text-gray-700 text-sm">
                        <li className="flex items-start space-x-2">
                          <span className="text-cyan-500">•</span>
              ...
              <div className="space-y-6">
                <div className="card-modern p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-normal text-gray-900 mb-3">Insurance Requirements</h3>
                      <ul className="space-y-2 text-gray-700 text-sm">
                        <li className="flex items-start space-x-2">
                          <span className="text-cyan-500">•</span>
                ...
                <div className="card-modern p-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center mt-1">
                      <span className="text-cyan-600 font-normal text-sm">5</span>
                    </div>
                    <div>
                      <h3 className="text-xl font-normal text-gray-900 mb-3">Sector-Specific Licenses</h3>
                      <ul className="space-y-2 text-gray-700 text-sm">
                        <li className="flex items-start space-x-2">
                          <span className="text-cyan-500">•</span>
                ...
                <div className="card-modern p-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center mt-1">
                      <span className="text-cyan-600 font-normal text-sm">6</span>
                    </div>
                    <div>
                      <h3 className="text-xl font-normal text-gray-900 mb-3">Galway Local Requirements</h3>
                      <ul className="space-y-2 text-gray-700 text-sm">
                        <li className="flex items-start space-x-2">
                          <span className="text-cyan-500">•</span>
        ...
        <section className="scroll-section py-16 px-4 bg-gray-50" id="galway-supports">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Local Enterprise Office Galway</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-normal mb-2">Start-up Support:</p>
                  ...
                  <div className="bg-cyan-50 p-3 rounded">
                    <p className="text-cyan-800 text-xs font-normal">Contact: County Hall, Prospect Hill</p>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Galway Chamber of Commerce</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-normal mb-2">Business Development:</p>
                    <ul className="space-y-1">
                  ...
                  <div className="bg-cyan-50 p-3 rounded">
                    <p className="text-cyan-800 text-xs font-normal">Active business community</p>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">NUI Galway Innovation</h3>
                <div className="space-y-3">
                  <div className="text-sm text-gray-700">
                    <p className="font-normal mb-2">Research & Development:</p>
                    <ul className="space-y-1">
                  ...
                  <div className="bg-cyan-50 p-3 rounded">
                    <p className="text-cyan-800 text-xs font-normal">University collaboration</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="scroll-section py-16 px-4" id="galway-sectors">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-premium p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-normal text-gray-900 mb-4">Technology Hub</h3>
                  <div className="space-y-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-normal text-blue-900 mb-2">Software & Tech</h4>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      <h4 className="font-normal text-green-900 mb-2">Life Sciences</h4>
                ...
                <div>
                  <h3 className="text-xl font-normal text-gray-900 mb-4">Tourism & Creative</h3>
                  <div className="space-y-4">
                    <div className="bg-orange-50 p-4 rounded-lg">
                      <h4 className="font-normal text-orange-900 mb-2">Tourism</h4>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <h4 className="font-normal text-purple-900 mb-2">Arts & Culture</h4>
        ...
        <section className="scroll-section py-16 px-4 bg-gray-50" id="galway-advantages">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Strategic Location</h3>
              ...
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Talent Pool</h3>
                <div className="space-y-3 text-sm text-gray-700">
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="text-cyan-500">✓</span>
              ...
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Quality of Life</h3>
                <div className="space-y-3 text-sm text-gray-700">
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="text-cyan-500">✓</span>
        ...
        <section className="scroll-section py-16 px-4" id="galway-checklist">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Complete Setup Process</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-normal text-gray-900 mb-3">Core Registrations</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
                  ...
                  <div>
                    <h4 className="font-normal text-gray-900 mb-3">Galway-Specific</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start space-x-2">
