          ...
          <div className="card-modern p-12 mb-2 hover-lift">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-12">
                ...
                <div className="card-modern p-6 hover-lift group">
                  <div className="icon-modern bg-[#005A8B] mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
        ...
        <section className="py-20" data-animate>
          <div className="card-modern p-12 mb-2 hover-lift">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              ...
              <div className="card-modern p-6 hover-lift group">
                <div className="icon-modern bg-[#005A8B] mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="card-premium p-12 mb-4 hover-lift relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="card-modern p-8 hover-lift group">
                  <div className="flex items-start gap-4">
                    <div className="icon-modern bg-[#005A8B] group-hover:scale-110 transition-transform duration-300">
                      <Users className="h-6 w-6 text-white" />
                    </div>
                    <div>
