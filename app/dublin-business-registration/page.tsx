          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">EU Headquarters</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                <div className="icon-modern w-16 h-16 mx-auto mb-6 bg-gray-100 text-petrol-base group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                  </svg>
                </div>
                <h3 className="text-xl font-normal text-gray-900 mb-4">Financial Hub</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Tech Innovation</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Step 1: National Business Registration (Week 1)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Companies Registration Office (CRO)</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Revenue Online Service (ROS)</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Business Bank Account</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Step 2: Dublin City Council Requirements (Week 1-2)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Commercial Rates Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Planning Permission Verification</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Signage and Advertising Permissions</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Step 3: Industry-Specific Licenses (Week 2-4)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-gray-600 rounded-full"></div>
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Food Business (if applicable)</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Liquor License (if applicable)</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Late Night Premises License</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Step 4: Dublin Business Supports & Networks (Week 2-8)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Local Enterprise Office Dublin City</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Dublin Chamber of Commerce</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Enterprise Ireland Supports</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Setup Costs in Dublin</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Company Registration</span>
                    <span className="font-normal text-petrol-base">€125-200</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Dublin City Council Rates</span>
                    <span className="font-normal text-petrol-base">€500-2,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Business Insurance (Dublin)</span>
                    <span className="font-normal text-petrol-base">€1,200-4,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Professional Services</span>
                    <span className="font-normal text-petrol-base">€2,000-8,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-normal text-gray-900">Bank Account & Setup</span>
                    <span className="font-normal text-petrol-base">€200-800</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Monthly Operating Costs</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Office Rent (City Centre)</span>
                    <span className="font-normal text-petrol-base">€35-65/m²</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Office Rent (Suburbs)</span>
                    <span className="font-normal text-petrol-base">€20-35/m²</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Utilities & Services</span>
                    <span className="font-normal text-petrol-base">€300-1,200</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Parking (if needed)</span>
                    <span className="font-normal text-petrol-base">€150-400</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-normal text-gray-900">Staff Costs (higher)</span>
                    <span className="font-normal text-petrol-base">+15-25%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-premium p-8 text-center">
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-6">
                <div>
                  ...
                  <div className="text-lg font-normal text-orange-600">+40-60%</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Staff Costs</div>
                  <div className="text-lg font-normal text-orange-600">+15-25%</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Business Rates</div>
                  <div className="text-lg font-normal text-orange-600">+30-50%</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Revenue Potential</div>
                  <div className="text-lg font-normal text-green-600">+50-100%</div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-modern p-8 border-l-4 border-petrol-500">
                <h3 className="text-xl font-normal text-petrol-base mb-3">Dublin 1 & 2 - City Centre</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-petrol-dark font-normal">Best for: Professional services, headquarters, client-facing businesses</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-green-500">
                <h3 className="text-xl font-normal text-green-600 mb-3">Dublin 4 - Ballsbridge & IFSC</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="text-green-800 font-normal">Best for: Financial services, consulting, B2B services, tech companies</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-petrol-500">
                <h3 className="text-xl font-normal text-petrol-base mb-3">Silicon Docks - Dublin 2 & 4</h3>
                <p className="text-gray-700 mb-4">
                  Tech cluster around Grand Canal, Google, Facebook, LinkedIn offices. Startup ecosystem and tech talent concentration.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-petrol-dark font-normal">Best for: Tech startups, software companies, digital agencies, fintech</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-orange-500">
                <h3 className="text-xl font-normal text-orange-600 mb-3">Dublin Suburbs - D6W, D14, D18</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  <p className="text-orange-800 font-normal">Best for: Manufacturing, distribution, back-office operations, cost-conscious businesses</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Government Supports</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-normal text-gray-900 mb-4">Funding & Networks</h3>
                <ul className="text-gray-600 space-y-2 text-left">
