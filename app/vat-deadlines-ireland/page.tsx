            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <div className="card-modern p-8 hover-lift border-l-4 border-red-500">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-normal text-foreground mb-2">Standard Deadline</h3>
                    <div className="text-4xl font-normal text-red-600 mb-2">19th</div>
                    <div className="text-sm text-muted-foreground">of the month after period ends</div>
                  </div>
                  
                  <div className="space-y-3">
                    <h4 className="font-normal text-foreground mb-2">Applies to:</h4>
                ...
                <div className="card-modern p-8 hover-lift border-l-4 border-green-500">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-normal text-foreground mb-2">ROS Extension</h3>
                    <div className="text-4xl font-normal text-green-600 mb-2">23rd</div>
                    <div className="text-sm text-muted-foreground">of the month after period ends</div>
                  </div>
              ...
              <div className="mt-8 p-6 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-normal text-yellow-800 mb-2">Important Distinction</h4>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <table className="w-full border-collapse bg-white rounded-lg shadow-soft">
                  <thead>
                    <tr className="bg-gray-50 border-b-2 border-primary/20">
                      <th className="text-left p-4 font-normal text-foreground">VAT Period</th>
                      <th className="text-center p-4 font-normal text-foreground">Return Due</th>
                      <th className="text-center p-4 font-normal text-foreground">Payment Due</th>
                      <th className="text-center p-4 font-normal text-foreground">ROS Filing</th>
                    </tr>
                  </thead>
                  <tbody className="text-sm">
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="p-4 font-normal text-foreground">Jan-Feb 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Mar 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Mar 2025</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 Mar 2025</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50 bg-blue-50">
                      <td className="p-4 font-normal text-foreground">Mar-Apr 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 May 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 May 2025</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 May 2025</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="p-4 font-normal text-foreground">May-Jun 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Jul 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Jul 2025</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 Jul 2025</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50 bg-blue-50">
                      <td className="p-4 font-normal text-foreground">Jul-Aug 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Sep 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Sep 2025</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 Sep 2025</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="p-4 font-normal text-foreground">Sep-Oct 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Nov 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Nov 2025</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 Nov 2025</td>
                    </tr>
                    <tr className="hover:bg-gray-50 bg-blue-50">
                      <td className="p-4 font-normal text-foreground">Nov-Dec 2025</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Jan 2026</td>
                      <td className="p-4 text-center text-red-600 font-normal">19 Jan 2026</td>
                      <td className="p-4 text-center text-green-600 font-normal">23 Jan 2026</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="mt-6 grid md:grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-red-50 rounded-lg">
                  <h4 className="font-normal text-red-800 mb-1">Return Filing</h4>
                  <p className="text-sm text-red-700">19th (23rd for ROS)</p>
                </div>
                <div className="p-4 bg-orange-50 rounded-lg">
                  <h4 className="font-normal text-orange-800 mb-1">Payment Due</h4>
                  <p className="text-sm text-orange-700">Always 19th</p>
                </div>
                <div className="p-4 bg-green-50 rounded-lg">
                  <h4 className="font-normal text-green-800 mb-1">Next Period</h4>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="card-modern p-6 hover-lift border-l-4 border-petrol-500">
                    ...
                    <div className="text-xs text-petrol-base font-normal">
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-lg border-l-4 border-petrol-500">
                <h4 className="font-normal text-petrol-dark mb-3">Can I Change My Return Period?</h4>
                <p className="text-sm text-petrol-dark mb-2">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-6 card-modern hover-lift border-l-4 border-orange-500">
                  <h3 className="font-normal text-foreground mb-3">Initial Penalty</h3>
                  <div className="text-3xl font-normal text-orange-600 mb-2">€150</div>
                ...
                <div className="text-center p-6 card-modern hover-lift border-l-4 border-red-500">
                  <h3 className="font-normal text-foreground mb-3">Daily Penalty</h3>
                  <div className="text-3xl font-normal text-red-600 mb-2">€10</div>
                  <p className="text-sm text-muted-foreground mb-4">
                ...
                <div className="text-center p-6 card-modern hover-lift border-l-4 border-red-700">
                  <h3 className="font-normal text-foreground mb-3">Maximum Penalty</h3>
                  <div className="text-3xl font-normal text-red-700 mb-2">€1,500</div>
                  <p className="text-sm text-muted-foreground mb-4">
              ...
              <div className="mt-8 p-6 bg-red-50 rounded-lg border-l-4 border-red-500">
                <h4 className="font-normal text-red-800 mb-3">Penalty Calculation Examples</h4>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-normal text-red-800 mb-2">30 days late:</h5>
                  ...
                  <div>
                    <h5 className="font-normal text-red-800 mb-2">60 days late:</h5>
                    <ul className="text-red-700 space-y-1">
                      <li>• Initial penalty: €150</li>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-6 card-modern hover-lift">
                  ...
                  <h3 className="font-normal text-foreground mb-2">Real-time Status</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="mt-8 p-6 bg-green-50 rounded-lg border border-green-200">
                <div className="text-center">
                  <h4 className="font-normal text-green-800 mb-3">Zero Late Filings Guarantee</h4>
