...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to filing VAT returns with Revenue Ireland through ROS. Step-by-step process, requirements, and PayVAT\'s automated filing service. Ensure compliance easily.',
}
