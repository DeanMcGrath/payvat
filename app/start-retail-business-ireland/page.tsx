          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Physical Shop</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Online Store</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Market Stall</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 1: Business Foundation (Weeks 1-4)</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">VAT Registration</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 2: Premises & Licensing (Weeks 2-8)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Shop Premises License</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Planning Permission</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Signage Permissions</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 3: Operational Setup (Weeks 4-10)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-petrol-base rounded-full"></div>
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">POS System & Equipment</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Insurance Coverage</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Staff & Payroll Setup</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 4: Stock & Launch Preparation (Weeks 6-12)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-petrol-base rounded-full"></div>
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Supplier Agreements</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Initial Stock Purchase</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Marketing & Launch</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Common Retail VAT Rates</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Most Goods (clothing, electronics)</span>
                    <span className="font-normal text-petrol-base">23%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Food & Beverages</span>
                    <span className="font-normal text-gray-600">0%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Books & Newspapers</span>
                    <span className="font-normal text-gray-600">0%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Children's Clothing & Footwear</span>
                    <span className="font-normal text-gray-600">0%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Medical Equipment</span>
                    <span className="font-normal text-gray-600">0%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-normal text-gray-900">Fuel & Energy</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Retail VAT Benefits</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Input VAT Recovery</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Wholesale Purchasing</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Business Credibility</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Cross-Border Trading</h4>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="card-modern p-6">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Small Shop (50m²)</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    ...
                    <span className="font-normal text-sm">€12,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                  ...
                  <div className="flex justify-between items-center font-normal pt-2">
                    ...
                    <span className="text-petrol-base">€26,500</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-6 border-2 border-petrol-200">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Medium Shop (100m²)</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Setup & Legal</span>
                    <span className="font-normal text-sm">€3,000</span>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Shop Fittings</span>
                    <span className="font-normal text-sm">€20,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">POS & Tech</span>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Initial Stock</span>
                    <span className="font-normal text-sm">€25,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Insurance</span>
                    <span className="font-normal text-sm">€2,500</span>
                  </div>
                  <div className="flex justify-between items-center font-normal pt-2">
                    <span className="text-gray-900">Total</span>
                    <span className="text-petrol-base">€56,500</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-6">
                <h3 className="text-xl font-normal text-gray-900 mb-4 text-center">Large Shop (200m²)</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Setup & Legal</span>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Shop Fittings</span>
                    <span className="font-normal text-sm">€45,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">POS & Tech</span>
                    <span className="font-normal text-sm">€12,000</span>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Initial Stock</span>
                    <span className="font-normal text-sm">€50,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700 text-sm">Insurance</span>
                    <span className="font-normal text-sm">€4,000</span>
                  </div>
                  <div className="flex justify-between items-center font-normal pt-2">
                    <span className="text-gray-900">Total</span>
                    <span className="text-petrol-base">€116,000</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-premium p-8 text-center">
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-6">
                <div>
                  ...
                  <div className="text-lg font-normal text-gray-900">€1,500-8,000</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Staff</div>
                  <div className="text-lg font-normal text-gray-900">€2,000-12,000</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Utilities</div>
                  <div className="text-lg font-normal text-gray-900">€300-1,200</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Marketing</div>
                  <div className="text-lg font-normal text-gray-900">€500-2,000</div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-modern p-8 border-l-4 border-red-500">
                <h3 className="text-xl font-normal text-red-600 mb-3">Mistake: Poor Stock Management</h3>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <p className="text-red-800 font-normal">Cost: 30-50% of retail failures due to cash flow tied up in dead stock</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-orange-500">
                <h3 className="text-xl font-normal text-orange-600 mb-3">Mistake: Ignoring VAT Recovery Opportunities</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  <p className="text-orange-800 font-normal">Cost: €5,000-20,000 in non-recoverable VAT and compliance penalties</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-yellow-500">
                <h3 className="text-xl font-normal text-yellow-600 mb-3">Mistake: Inadequate Security Measures</h3>
                <p className="text-gray-700 mb-4">
                  No CCTV, basic till security, inadequate stock protection. Retail theft averages 1.4% of turnover in Ireland.
                </p>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="text-yellow-800 font-normal">Cost: €1,400 theft loss per €100,000 turnover + insurance claims</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-petrol-500">
                <h3 className="text-xl font-normal text-petrol-base mb-3">Mistake: No Digital Presence</h3>
                <p className="text-gray-700 mb-4">
                  Relying solely on walk-in customers without online presence, social media, or click-and-collect options.
                </p>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-petrol-dark font-normal">Impact: Missing 60% of customers who research products online first</p>
                </div>
              </div>
            </div>
          </div>
