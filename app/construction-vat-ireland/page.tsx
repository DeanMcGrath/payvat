          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Principal Contractors</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Subcontractors</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Material Suppliers</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Construction Services VAT</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">General Construction Services</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">House Building Services</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Repair & Maintenance</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Cleaning Services</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-normal text-gray-900">Security Services</span>
                    <span className="font-normal text-red-600">23%</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Materials & Equipment VAT</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Building Materials</span>
                    <span className="font-normal text-red-600">23%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Plant & Equipment Hire</span>
                    <span className="font-normal text-red-600">23%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Scaffolding Hire</span>
                    <span className="font-normal text-red-600">23%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Tool Hire</span>
                    <span className="font-normal text-red-600">23%</span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <div className="card-premium p-8">
              <h3 className="text-2xl font-normal text-gray-900 mb-6">Mixed Supplies: Materials + Services</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-normal text-gray-900 mb-3">Two-Third Rule Application</h4>
                ...
                <div>
                  <h4 className="font-normal text-gray-900 mb-3">Common Examples</h4>
                  <ul className="space-y-2 text-gray-700 text-sm">
        ...
        <section className="scroll-section py-16 px-4" id="rct-compliance">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">1. RCT Registration Requirements</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-normal text-gray-900 mb-3">Principal Contractor Registration</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                  ...
                  <div>
                    <h4 className="font-normal text-gray-900 mb-3">Subcontractor Registration</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">2. RCT Deduction Rates</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-green-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-normal text-green-600">0%</div>
                    <p className="text-green-800 text-sm mt-2">C2 certificate holders (tax compliant)</p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-normal text-petrol-base">20%</div>
                    <p className="text-petrol-dark text-sm mt-2">Standard rate for registered subcontractors</p>
                  </div>
                  <div className="bg-red-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-normal text-red-600">35%</div>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">3. Monthly RCT Returns</h3>
                <div className="space-y-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-normal text-blue-900 mb-2">Return Requirements</h4>
                  ...
                  <div className="bg-red-50 p-4 rounded-lg">
                    <h4 className="font-normal text-red-900 mb-2">Penalties for Late Returns</h4>
        ...
        <section className="scroll-section py-16 px-4 bg-gray-50" id="construction-vat-registration">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="card-modern p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">High Input VAT Recovery</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-[#8FD0FC] rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Supplier Relationships</h4>
              ...
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Typical VAT Recovery Amounts</h3>
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-normal text-gray-900 mb-2">Small Construction Business</h4>
                    <div className="text-2xl font-normal text-petrol-base">€8,000-15,000</div>
                    <p className="text-gray-600 text-sm">Annual VAT recovery on equipment and materials</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-normal text-gray-900 mb-2">Medium Construction Company</h4>
                    <div className="text-2xl font-normal text-petrol-base">€25,000-60,000</div>
                    <p className="text-gray-600 text-sm">Annual VAT recovery including vehicles and plant</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-normal text-gray-900 mb-2">Large Construction Enterprise</h4>
                    <div className="text-2xl font-normal text-petrol-base">€100,000+</div>
        ...
        <section className="scroll-section py-16 px-4" id="construction-automation">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-premium p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-normal text-gray-900 mb-4">VAT Automation</h3>
                ...
                <div>
                  <h3 className="text-xl font-normal text-gray-900 mb-4">RCT Integration</h3>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start space-x-3">
