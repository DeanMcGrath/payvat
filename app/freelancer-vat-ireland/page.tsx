  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                ...
                <div className="text-center mb-6">
                  <div className="text-5xl font-bold text-indigo-600 mb-2">€42,500</div>
              ...
              <div className="card-modern p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">Voluntary Registration</h4>
                    <p className="text-blue-800 text-sm">Can register early for credibility and expense recovery</p>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="card-premium p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">Reverse Charge for B2B EU Services</h4>
                    <p className="text-blue-800 text-sm">For services to EU businesses with valid VAT numbers, apply 0% VAT and state "Reverse charge applies"</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-indigo-600">Bi-Monthly</div>
                      <p className="text-gray-600 text-sm">Most freelancers file every 2 months</p>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-indigo-600">19th</div>
                      <p className="text-gray-600 text-sm">Payment due date</p>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-indigo-600">23rd</div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="card-modern p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">EC Sales List Required</h4>
                    <p className="text-blue-800 text-sm">Monthly return listing all EU B2B sales. Due by 15th of following month.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-modern p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-purple-900 mb-2">Non-EU Clients</h4>
                    <p className="text-purple-800 text-sm">Generally zero-rated (0% VAT) as exports of services outside EU.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Call to Action */}
        <section className="scroll-section py-20 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
