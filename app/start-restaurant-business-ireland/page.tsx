          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Food Business Registration</h3>
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">Planning Permission</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="card-modern p-8 text-center hover:shadow-xl transition-all duration-300 group">
                ...
                <h3 className="text-xl font-normal text-gray-900 mb-4">VAT Registration</h3>
                <p className="text-gray-600 leading-relaxed">
        ...
        <section className="scroll-section py-16 px-4 bg-gray-50" id="restaurant-checklist">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-premium p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Business Structure & Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Tax Registration</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 2: Food Business Registration (Weeks 2-6)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">FSAI Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Local Authority Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">HACCP Training</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 3: Premises & Licensing (Weeks 4-12)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-gray-600 rounded-full"></div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Fire Safety Certificate</h4>
              ...
              <div className="card-premium p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">Phase 4: Operational Setup (Weeks 8-16)</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-1">
                      <div className="w-3 h-3 bg-petrol-base rounded-full"></div>
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">Staff Registration</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">VAT Compliance Setup</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-normal text-gray-900">POS System & VAT Compliance</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">VAT Rates for Restaurants</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Restaurant Meals (dine-in)</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Hot Takeaway Food</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Cold Takeaway Food</span>
                    <span className="font-normal text-gray-600">0%</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="font-normal text-gray-900">Alcohol</span>
                    <span className="font-normal text-gray-700">23%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-normal text-gray-900">Catering Services</span>
                    <span className="font-normal text-petrol-base">13.5%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="card-modern p-8">
                <h3 className="text-2xl font-normal text-gray-900 mb-6">VAT Registration Benefits</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Reclaim Setup VAT</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Professional Credibility</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">Cash Flow Management</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-petrol-light rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-normal text-gray-900">B2B Opportunities</h4>
        ...
        <section className="scroll-section py-16 px-4 bg-gray-50" id="restaurant-costs">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-6">Essential Setup Costs</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Company Registration</span>
                    <span className="font-normal">€125-200</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Food Business Registration</span>
                    <span className="font-normal">€150-500</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Planning Permission</span>
                    <span className="font-normal">€65-700</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Liquor License</span>
                    <span className="font-normal">€4,000-8,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">VAT Compliance Service</span>
                    <span className="font-normal">€500-1,200</span>
                  </div>
                  <div className="flex justify-between items-center font-normal text-lg pt-2">
                    <span className="text-gray-900">Legal/Admin Total</span>
                    <span className="text-petrol-base">€6,000-14,000</span>
                  </div>
                </div>
              </div>
              
              <div className="card-modern p-8">
                <h3 className="text-xl font-normal text-gray-900 mb-6">Operational Setup Costs</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Kitchen Equipment</span>
                    <span className="font-normal">€25,000-75,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Furniture & Fittings</span>
                    <span className="font-normal">€15,000-40,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">POS System & Technology</span>
                    <span className="font-normal">€3,000-8,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Initial Stock</span>
                    <span className="font-normal">€5,000-15,000</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="text-gray-700">Marketing & Signage</span>
                    <span className="font-normal">€3,000-10,000</span>
                  </div>
                  <div className="flex justify-between items-center font-normal text-lg pt-2">
                    <span className="text-gray-900">Operational Total</span>
                    <span className="text-petrol-base">€51,000-148,000</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center items-center gap-4 mb-6">
                  <div className="text-center">
                    ...
                    <div className="text-3xl font-normal text-petrol-base">€57,000</div>
                  </div>
                  <div className="text-gray-400 text-2xl">-</div>
                  <div className="text-center">
                    <div className="text-sm text-gray-600">Typical</div>
                    <div className="text-3xl font-normal text-petrol-base">€162,000</div>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="card-modern p-8 border-l-4 border-gray-400">
                <h3 className="text-xl font-normal text-gray-800 mb-3">Mistake: Not Registering for VAT Early</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-800 font-normal">Cost: €5,000-15,000 in non-recoverable VAT</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-gray-400">
                <h3 className="text-xl font-normal text-gray-800 mb-3">Mistake: Poor VAT Registration Timing</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-800 font-normal">Cost: €10,000+ in non-recoverable setup VAT and credibility issues</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-gray-400">
                <h3 className="text-xl font-normal text-gray-800 mb-3">Mistake: Poor Cash Flow Planning</h3>
                <p className="text-gray-700 mb-4">
                  Underestimating working capital needs and not accounting for 3-6 month ramp-up period before profitability.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-800 font-normal">Result: 40% of restaurants fail within first year due to cash flow</p>
                </div>
              </div>
              
              <div className="card-modern p-8 border-l-4 border-gray-400">
                <h3 className="text-xl font-normal text-gray-800 mb-3">Mistake: Manual VAT Management</h3>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-800 font-normal">Cost: 15-20 hours per month + penalties for errors</p>
                </div>
              </div>
            </div>
          </div>
