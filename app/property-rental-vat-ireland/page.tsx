        ...
        <section className={`relative py-20 px-4 transition-all duration-1000 ${
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 bg-amber-50 rounded-full text-amber-700 text-sm font-medium mb-6 animate-pulse">
              ...
              Property Rental VAT Ireland Guide
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Property Rental VAT in 
              <span className="bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
                Ireland (2025)
              </span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Complete VAT guide for property rentals. Residential exemptions, commercial property VAT, Airbnb rules, and landlord compliance requirements.
            </p>
